...
/**
 * Performs HTTP MKCOL Method
 *
 * @author   Adam Retter <adam.retter@devon.gov.uk>
 * @author   Andrzej Taramina <andrzej@chaeron.com>
 * @author   Jonathan Lauper * @version  1.3
 * @serial   20100228
 */
public class MKCOLFunction extends BaseHTTPClientFunction
{
    protected static final Logger         logger    = Logger.getLogger( GETFunction.class );

    public final static FunctionSignature signatures[]  = {
        new FunctionSignature(
            new QName( "mkcol", NAMESPACE_URI, PREFIX ),
            "Performs a HTTP MKCOL request." +
    ...
    public MKCOLFunction(XQueryContext context, FunctionSignature signature)
    {
    ...
    public Sequence eval( Sequence[] args, Sequence contextSequence ) throws XPathException
    {
        ...
        //setup MKCOL request
        MkColMethod get            = new MkColMethod( url );

        //setup MKCOL Request Headers
        if( !args[2].isEmpty() ) {
