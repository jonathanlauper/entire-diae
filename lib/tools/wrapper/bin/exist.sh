...
# Application
APP_NAME="eXist-db"
APP_LONG_NAME="eXist-db Native XML Database"
...
PLIST_DOMAIN=org.existdb.wrapper
...
# It is more reliable however to determine the location with /usr/libexec/java_home
if [ "$DIST_OS" = "macosx" ]
then
    if [ -z "$JAVA_HOME" ]; then
